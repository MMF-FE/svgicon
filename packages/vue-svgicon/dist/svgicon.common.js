...
// CONCATENATED MODULE: ./src/components/SvgIcon.vue?vue&type=template&id=0933b814&
...
// CONCATENATED MODULE: ./src/SvgIcon.ts

var SvgIcon_SvgIcon = /** @class */ (function () {
    ...
    Object.defineProperty(SvgIcon.prototype, "box", {
        get: function () {
            var width = parseFloat(this.props.width) || 16;
            var height = parseFloat(this.props.width) || 16;
            if (this.iconData) {
    ...
    Object.defineProperty(SvgIcon.prototype, "style", {
        get: function () {
            var digitReg = /^\d+$/;
            var scale = Number(this.props.scale);
            var width;
            var height;
            // apply scale
...
/* harmony default export */ var src_SvgIcon = (SvgIcon_SvgIcon);
...
/* harmony default export */ var SvgIconvue_type_script_lang_ts_ = (external_commonjs_vue_commonjs2_vue_root_Vue_default.a.extend({
    ...
    data: function () {
        return {
            svgicon: new src_SvgIcon({}),
        };
    },
    created: function () {
        this.svgicon = new src_SvgIcon(this.$attrs);
    },
    methods: {
        onClick: function (e) {
            this.$emit('click', e);
...
function setOptions(opts) {
    ...
    src_SvgIcon.options = __assign(__assign({}, src_SvgIcon.options), opts);
}
