                ...
                <View className={styles.form}>
                    <View className={styles.formItem}>
                      <View className={styles.formControl}>
                         <Picker className={styles.picker} mode='selector' value={iconIndex} range={this.iconSelector} onChange={e => {
                             const ix = Number(e.detail.value)
                             this.updateIcon(ix)
                            }}
                         >
                           <View className="mmf-row content-sb">
                                <View className={styles.formLabel}>选择图标</View>
                    ...
                    <View className={styles.formItem}>
                      <View className={styles.formControl}>
                         <Picker className={styles.picker} mode='selector' value={0} range={this.dirList} onChange={e => {
                             this.updateProps('dir', this.dirList[e.detail.value])
                            }}
                         >
                           <View className="mmf-row content-sb">
                                <View className={styles.formLabel}>方向:</View>
                                <View className='picker'>
                                    {props.dir}
                                </View>
                           </View>
                    ...
                    <View className={styles.formItem}>
                        ...
                        <View className={styles.formControl}>
                            <Input
                                ...
                                onInput={(e) => {
                                    this.updateProps('scale', e.detail.value)
                                }}/>
                        </View>
                    </View>
                    ...
                    <View className={styles.formItem}>
                        <View className={styles.formLabel}>显示原始图标：</View>
                        <View className={styles.formControl}>
                            <View className={classNames({
                                [styles.checkbox]: true,
                            ...
                            onClick={e => {
                                this.updateProps('original', !props.original)
                            }}></View>
                        </View>
                    </View>
